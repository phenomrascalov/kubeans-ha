...
ExecStart=/usr/local/bin/etcd \
  ...
  --client-cert-auth \
  --initial-advertise-peer-urls https://#master2#:2380 \
  --listen-peer-urls https://#master2#:2380 \
  --listen-client-urls https://#master2#:2379,http://127.0.0.1:2379 \
  --advertise-client-urls https://#master2#:2379 \
